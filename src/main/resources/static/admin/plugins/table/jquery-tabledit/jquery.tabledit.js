        ...
        var defaults = {
            ...
            buttons: {
                edit: {
                    ...
                    html: '<span class="flaticon-edit-5"></span>',
                    action: 'edit'
                },
                delete: {
                    class: 'btn btn-sm btn-warning',
                    html: '<span class="flaticon-delete-6"></span>',
                    action: 'delete'
                },
                save: {
            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        // Create edit button.
                        if (settings.editButton) {
                            editButton = '<button type="button" class="tabledit-edit-button mb-2 ' + settings.buttons.edit.class + '" style="float: none;">' + settings.buttons.edit.html + '</button>';
                        }

                        // Create delete button.
                        if (settings.deleteButton) {
                            deleteButton = '<button type="button" class="tabledit-delete-button mb-2 ' + settings.buttons.delete.class + '" style="float: none;">' + settings.buttons.delete.html + '</button>';
