...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        ads.add(new Advertisement("HTML, CSS Developer", cities.get(1), categories.get(0), "На роботу HTML, CSS Developer", null, "qual", "пропозиція наша наступна", LocalDate.now(), new BigDecimal("24000.0"), "повний робочий день", Status.CHECK, users.get(0)));
